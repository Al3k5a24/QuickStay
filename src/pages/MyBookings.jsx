...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-3.5 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title={'My Bookings'} 
      subTitle='Easely manage your past, current, and upcoming hotel reservations in one place. Plan your trips seamlessly with just a few clicks'
      align='left'/>
          ...
          border-b border-gray-300 py-6 first:border-t'>
            ...
            <div className='flex flex-col md:flex-row'>
              <img className='min-md:w-44 rounded shadow object-cover'
               ...
               <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                <p className='font-playfair text-[24px]'>{booking.hotel.name}
                <span className='font-inter text-sm ml-1'>({booking.room.roomType})</span>
                </p>
            ...
            <div className='flex flex-col items-start justify-center pt-2'>
              <div className='flex items-center gap-2 pb-2'>
                ...
                {!booking.isPaid && (
                  <button className='px-4 py-1.5 ml-1 text-xs border border-gray-400
